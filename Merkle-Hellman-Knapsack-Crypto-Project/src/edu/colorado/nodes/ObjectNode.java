...
public class ObjectNode
{
    ...
    /**
     * Time: O(n)
     * Recursive method to copy the linked list.
     * @param source head node
    ...
    public static ObjectNode listCopy_rec(ObjectNode source) {
        ...
        ObjectNode copyNode = new ObjectNode(source.data,null);
        copyNode.link =listCopy_rec(source.link);
        return copyNode;
    }
    ...
    public static int listLength_rec(ObjectNode head) {
        ...
        int cur = listLength_rec(head.link) + 1;
        return cur;
    }
    ...
    public String toString() {
        ...
        ObjectNode head = new ObjectNode(data,link);
        while(head!= null) {
            sb.append(head.data);
            head = head.link;
        }
    ...
    public static void main(String[] args) {
        // a. the creation of the linked list
        ...
        // b. data of the linked list
        System.out.println(head.toString());
        // c. size of the linked list
