...
public class SinglyLinkedList {
     ...
     * PreCondition: c is an object
     * PostCondition: c is added to the end of the linked list and worked as the tail
     *                node number is increased by one
     * @param c add object
     */
     ...
     * PreCondition: c is an object
     * PostCondition: c is added to the linked list and worked as the head
     *                node number is increased by one
     * @param c add object
     */
     ...
     * PreCondition: i is within [0, length of nodes]
     * PostCondition: cur point to the returned node
     * @param i index
     ...
     * PreCondition: cur and head is not null
     * PostCondition: cur point to the head node
     */
    public void reset() {
        cur = head;
    }
     ...
     * PostCondition: cur go the next node
     ...
     * PostCondition: the head in string format is returned
